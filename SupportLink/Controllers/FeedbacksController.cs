...
namespace SupportLink.Controllers
{
    public class FeedbacksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UpdateId,Rating,Comments,CreatedAt")] Feedback feedback)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UpdateId,Rating,Comments,CreatedAt")] Feedback feedback)
        {
            if (id != feedback.Id)
            {
                return NotFound();
