...
namespace SupportLink.Controllers
{
    public class TicketUpdatesController : Controller
    {
        ...
        {
            var supportLinkDbContext = _context.TicketUpdates.Include(t => t.UpdatedBy);
        ...
        {
            ViewData["UpdatedById"] = new SelectList(_context.ApplicationUsers, "UserId", "Email");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,SupportId,UpdatedById,UpdateDetails,UpdatedAt")] TicketUpdate ticketUpdate)
        {
            ...
            ViewData["UpdatedById"] = new SelectList(_context.ApplicationUsers, "UserId", "Email", ticketUpdate.UpdatedById);
            return View(ticketUpdate);
        }
